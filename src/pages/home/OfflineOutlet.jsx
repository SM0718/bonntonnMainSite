...
const OfflineOutlet = () => {
  return (
    <div className="text-center px-4 sm:px-8 md:px-16 lg:px-24 py-6 sm:py-8 md:py-12 w-full min-h-[300px] sm:min-h-[400px] md:min-h-[500px] flex flex-col justify-center items-center bg-white">
      <div className="w-full h-[300px] sm:h-[400px] md:h-[500px] flex justify-center items-center mb-4">
        <iframe
      ...
      <a
        ...
        className="text-blue-500 hover:text-blue-700 underline text-sm sm:text-base transition-colors duration-300 mt-2 sm:mt-4"
      >
